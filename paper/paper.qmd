...
ggplot(inspections_over_time, aes(x = month, y = inspections)) +
  ...
  theme(
    ...
    plot.subtitle = element_text(hjust = 0.5, size = 12, color = "gray40"),  # Style subtitle
    axis.title.x = element_text(size = 12, face = "bold"),  # Style x-axis label
    axis.title.y = element_text(size = 12, face = "bold"),  # Style y-axis label
